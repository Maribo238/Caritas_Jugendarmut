...
class _FinanzplanerWidgetState extends State<FinanzplanerWidget>
  ...
  Future<void> verrechnen() async {
    double value = await _value + einnahmen - ausgaben;
    einnahmen = 0;
    ausgaben = 0;
    value = double.parse(value.toStringAsFixed(2));
    sendAndUpdateWidget(value);
  ...
  Future<double> get _value async {
    final value =
        await HomeWidget.getWidgetData<double>('amount', defaultValue: 0);
    return value!;
  }

  Future<void> sendAndUpdateWidget([double? amount]) async {
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          preferredSize: Size.fromHeight(
              60), // Hier können Sie die Höhe der AppBar festlegen
          child: AppBar(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage(
                            'assets/hintergrund.jpeg'), // Pfad zum lokalen Hintergrundbild
